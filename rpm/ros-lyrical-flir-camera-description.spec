...
%global pkg_name flir_camera_description
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-flir-camera-description
Version:        3.0.5
Release:        1%{?dist}
...
* Wed Apr 29 2026 Luis Camero <lcamero@clearpathrobotics.com> - 3.0.4-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Luis Camero <lcamero@clearpathrobotics.com> - 3.0.4-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Luis Camero <lcamero@clearpathrobotics.com> - 3.0.4-1
- Autogenerated by Bloom
