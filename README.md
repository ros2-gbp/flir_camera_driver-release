## flir_camera_driver (lyrical) - 3.0.5-1

The packages in the `flir_camera_driver` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --ros-distro lyrical flir_camera_driver` on `Fri, 08 May 2026 20:25:46 -0000`
...
## flir_camera_driver (rolling) - 3.0.5-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling flir_camera_driver` on `Fri, 08 May 2026 20:23:27 -0000`
...
## flir_camera_driver (jazzy) - 3.0.5-1

The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy flir_camera_driver` on `Fri, 08 May 2026 20:21:22 -0000`
...
## flir_camera_driver (rolling) - 3.0.4-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling flir_camera_driver` on `Wed, 19 Nov 2025 13:33:17 -0000`
...
## flir_camera_driver (kilted) - 3.0.4-1

The packages in the `flir_camera_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted flir_camera_driver` on `Wed, 19 Nov 2025 13:07:43 -0000`
...
## flir_camera_driver (jazzy) - 3.0.4-1

The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy flir_camera_driver` on `Wed, 19 Nov 2025 13:02:57 -0000`
...
## flir_camera_driver (kilted) - 3.0.3-2

The packages in the `flir_camera_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted flir_camera_driver` on `Tue, 15 Jul 2025 09:09:12 -0000`
...
## flir_camera_driver (rolling) - 3.0.3-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling flir_camera_driver` on `Mon, 14 Jul 2025 20:16:01 -0000`
...
## flir_camera_driver (rolling) - 3.0.2-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling flir_camera_driver` on `Sun, 25 May 2025 17:15:10 -0000`
...
## flir_camera_driver (kilted) - 3.0.2-1

The packages in the `flir_camera_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted flir_camera_driver` on `Sun, 25 May 2025 17:13:01 -0000`
...
The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --edit-track flir_camera_driver` on `Sun, 25 May 2025 17:11:01 -0000`
...
## flir_camera_driver (jazzy) - 3.0.1-1

The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy flir_camera_driver` on `Tue, 01 Apr 2025 12:13:50 -0000`
...
## flir_camera_driver (rolling) - 3.0.1-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling flir_camera_driver` on `Tue, 01 Apr 2025 12:11:07 -0000`
...
The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy --edit-track flir_camera_driver` on `Thu, 21 Nov 2024 14:49:00 -0000`
...
- upstream repository: https://github.com/ros-drivers/flir_camera_driver.git
- release repository: https://github.com/ros2-gbp/flir_camera_driver-release.git
- rosdistro version: `2.0.20-1`
- old version: `2.0.20-1`
- new version: `3.0.0-1`
...
## flir_camera_driver (rolling) - 3.0.0-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling --edit-track flir_camera_driver` on `Thu, 21 Nov 2024 14:40:31 -0000`
...
## flir_camera_driver (jazzy) - 2.0.20-1

The packages in the `flir_camera_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy flir_camera_driver` on `Thu, 20 Jun 2024 12:43:33 -0000`
...
## flir_camera_driver (rolling) - 2.0.20-1

The packages in the `flir_camera_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling flir_camera_driver` on `Thu, 20 Jun 2024 12:41:11 -0000`
...
## flir_camera_driver (jazzy) - 2.0.19-1
